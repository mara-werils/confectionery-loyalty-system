  ...
  return (
    <div className="space-y-6 pb-24 md:pb-6">
      ...
      <div>
        ...
        <p className="text-sm text-stone-500 mt-1">Хронология всех системных действий</p>
      </div>
      ...
      <GlassCard delay={0.05} className="p-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-xs font-medium text-stone-500 uppercase tracking-wider">Фильтр по типу действия</span>
        </div>
      ...
      <GlassCard delay={0.1} className="p-0 overflow-hidden">
        {isLoading ? (
          ...
          <div className="py-16 text-center">
            ...
            <p className="text-stone-500 text-sm">Записи не найдены</p>
          </div>
        ) : (
                  ...
                  >
                    <div className="ml-7 p-4 bg-stone-800/30 rounded-xl border border-stone-700/30 space-y-2">
                      <div className="grid grid-cols-2 gap-3 text-xs">
                        <div>
                          <span className="text-stone-600 uppercase tracking-wider text-[10px]">ID записи</span>
                          <p className="text-stone-400 font-mono mt-0.5 break-all">{log.id}</p>
                        </div>
                        <div>
                          <span className="text-stone-600 uppercase tracking-wider text-[10px]">Актор</span>
                        ...
                        <div>
                          <span className="text-stone-600 uppercase tracking-wider text-[10px]">Тип сущности</span>
                          <p className="text-stone-400 mt-0.5">{log.entityType}</p>
                        </div>
                        <div>
                          <span className="text-stone-600 uppercase tracking-wider text-[10px]">ID сущности</span>
                      ...
                      {log.metadata && Object.keys(log.metadata).length > 0 && (
                        <div className="pt-2 border-t border-stone-700/30">
                          <span className="text-stone-600 uppercase tracking-wider text-[10px]">Метаданные</span>
      ...
      <div className="text-center">
        <p className="text-xs text-stone-600">
          Всего записей: {pagination.total || logs.length} · Страница {page} из {pagination.pages || 1}
        </p>
      </div>
    </div>
  );
